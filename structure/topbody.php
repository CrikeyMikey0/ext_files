...
<div class="topbar">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <p class="pull-left hidden-xs">Sunset Bites Restaurant, the BEST in Town</p>
        <p class="pull-right"><i class="fa fa-phone"></i>Order Online 91545 79650</p>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="col-md-12">
          <nav class="navbar navbar-default">
            <div class="navbar-header">
              ...
              <a class="navbar-brand logo-center" href="index.html"><img src="images/logo.png" alt="logo"
