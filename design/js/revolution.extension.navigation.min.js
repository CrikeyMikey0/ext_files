    ...
    var a = function(t, e) {
        ...
        r = function(t) {
            ...
            return (
                ...
                (n > 300 || -300 > n) && (n /= 10), { spinX: e, spinY: i, pixelX: a, pixelY: n }
            );
        },
        o = function(t, i) {
            ...
            if (
                ...
                t.on("mousewheel DOMMouseScroll", function(o) {
                    var s = r(o.originalEvent),
                        ...
                        !1,
                        u = !0;
                    "carousel" == i.navigation.mouseScrollNavigation && (h = p = !1), -1 == l ?
                        s.pixelY < a ?
                        (h ||
                            ((i.sc_indicator = "arrow"),
                                ...
                                if ("end" == n && !m) {
                                    ...
                                    if (
                                        ...
                                        return (
                                            ...
                                            e.callingNewSlide(a, a.c, -1), !1
                                        );
                                }
                                return (
                                    (a.dragStartedOverSlider = !1),
                                    (a.dragStartedOverThumbs = !1),
                                    (a.dragStartedOverTabs = !1), !0
                                );
                            }
                                ...
                                case "cancel":
                                    if (m)
                                        return (
                                            ...
                                            t.parent().find(w).removeClass("dragged"), !1
                                        );
                            }
                        }
                    },
        ...
        c = function(t, e) {
            ...
            u(e.navigation.arrows) &&
                punchgs.TweenLite.delayedCall(
                    ...
                    g, [a.find(".tparrows"), e.navigation.arrows, "hide"]
                ),
                ...
                punchgs.TweenLite.delayedCall(
                    ...
                    g, [a.find(".tp-bullets"), e.navigation.bullets, "hide"]
                ),
                u(e.navigation.thumbnails) &&
                punchgs.TweenLite.delayedCall(
                    i ?
                    ...
                    g, [a.find(".tp-thumbs"), e.navigation.thumbnails, "hide"]
                ),
                u(e.navigation.tabs) &&
                punchgs.TweenLite.delayedCall(
                    i ?
                    ...
                    g, [a.find(".tp-tabs"), e.navigation.tabs, "hide"]
                );
        },
        g = function(t, e, i, a) {
