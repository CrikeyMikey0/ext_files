        ...
        revscroll: function(e) {
            return this.each(function() {
                ...
                t != undefined &&
                    t.length > 0 &&
                    jQuery("body").find("#" + t.attr("id")).length > 0 &&
                    jQuery("body,html").animate({ scrollTop: t.offset().top + t.height() - e + "px" }, { duration: 400 });
            });
        },
        ...
        runSlider = function(e, t) {
            ...
            if (
                (t.shadow !== undefined &&
                    ...
                    setCurWinRange(t),
                    setCurWinRange(t, !0), !e.hasClass("revslider-initialised"))
            ) {
                ...
                v != undefined &&
                    ...
                    setTimeout(function() {
                        "carousel" == t.sliderType && _R.prepareCarousel(t), !v.enable ||
        ...
        containerResized = function(e, t) {
            if (
                (1 == t.infullscreenmode && (t.minHeight = jQuery(window).height()),
                    setCurWinRange(t),
                    setCurWinRange(t, !0), !_R.resizeThumbsTabs || _R.resizeThumbsTabs(t) === !0)
            ) {
                if (
