                ...
                case "youtube":
                    if (0 == e.find("iframe").length)
                        ...
                        1 == e.data("nextslideatend-triggered") &&
                            ((s = -1), e.data("nextslideatend-triggered", 0)), -1 != n && n > s && e.data("player").seekTo(n),
                    ...
                    if (0 == e.find("iframe").length)
                        ...
                        void 0 == u.api("play") ?
                            ...
                            setTimeout(function() {
                                ...
                                1 == e.data("nextslideatend-triggered") &&
                                    ((i = -1), e.data("nextslideatend-triggered", 0)), -1 != a && a > i && u.api("seekTo", a);
                            }, 510);
                    } else
                        e.data(
                            "videoplaywait",
                ...
                case "html5":
                    ...
                    if (1 != g.data("metaloaded"))
                        d(
                            ...
                            (function(e) {
                                ...
                                var i = t(e.data("videostartat")),
                                    d = c.currentTime;
                                1 == e.data("nextslideatend-triggered") &&
                                    ((d = -1), e.data("nextslideatend-triggered", 0)), -1 != i && i > d && (c.currentTime = i);
                            })(e)
                        );
                    else {
                        c.play();
                        var n = t(e.data("videostartat")),
                            s = c.currentTime;
                        1 == e.data("nextslideatend-triggered") &&
                            ((s = -1), e.data("nextslideatend-triggered", 0)), -1 != n && n > s && (c.currentTime = n);
                    }
            }
        },
            ...
            switch ((e.data("videotype", k), x)) {
                ...
                case "youtube":
                    ...
                    "https:" === location.protocol && (b = "https"),
                        "none" == h &&
                        ((u = u.replace("controls=1", "controls=0")), -1 == u.toLowerCase().indexOf("controls") &&
                            (u += "&controls=0"));
        ...
        r = function(e, d, r) {
            ...
            if (
                ...
                switch (e.data("videotype")) {
                    case "youtube":
                        r &&
                            (e.data("player").playVideo(), -1 != L && e.data("player").seekTo());
                        break;
                    case "vimeo":
                        if (r) {
