...
!(function(a) {
    ...
    jQuery.extend(!0, t, {
        ...
        animateSingleCaption: function(a, r, s, f, b, x, T) {
            ...
            if (
                ...
                if (
                    (a.data("layertype", "video"),
                        t.manageVideoLayer && t.manageVideoLayer(a, r, x, L), !x && !L)
                ) {
                    a.data("videotype");
            ...
            T ||
                ...
                L ||
                (2 != W && a.data("timeline").gotoAndPlay(0), (L = !0)), !x &&
                a.data("timeline_out") &&
                2 != W &&
                0 != W &&
    ...
    var i = function() {
        ...
        l = function(a, e, t, i, n, o, r) {
            return (!jQuery.isNumeric(a) && a.match(/%]/g) ?
                ((a = a.split("[")[1].split("]")[0]),
                    "horizontal" == r ?
        ...
        w = function(a, e, t, i) {
            ...
            if (
                ("off" === i && ((d = 1), (s = 1)),
                    "auto" == r.lineHeight && (r.lineHeight = r.fontSize + 4), !a.hasClass("tp-splitted"))
            ) {
        ...
        y = function(a, e) {
                ...
                a
                    ...
                    .append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", rotation: t, transformOrigin: o }, { rotation: i, ease: r }
                        )
                    ),
                    a.data("loop-timeline").append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", rotation: i, transformOrigin: o }, {
                                rotation: t,
                                ease: r,
                                onComplete: function() {
            ...
            if (a.hasClass("rs-rotate") && void 0 == a.data("loop-timeline")) {
                ...
                a.data("loop-timeline").append(
                    new punchgs.TweenLite.fromTo(
                        a,
                        n, { force3D: "auto", rotation: t, transformOrigin: o }, {
                            rotation: i,
                            ease: r,
                            onComplete: function() {
                                a.data("loop-timeline").restart();
            ...
            if (a.hasClass("rs-slideloop") && void 0 == a.data("loop-timeline")) {
                ...
                a
                    ...
                    .append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", x: d, y: s }, { x: l, y: p, ease: r }
                        )
                    ),
                    a.data("loop-timeline").append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", x: l, y: p }, {
                                x: d,
                                y: s,
                                onComplete: function() {
                                    a.data("loop-timeline").restart();
            ...
            if (a.hasClass("rs-pulse") && void 0 == a.data("loop-timeline")) {
                ...
                a
                    ...
                    .append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", scale: h }, { scale: c, ease: r }
                        )
                    ),
                    a.data("loop-timeline").append(
                        new punchgs.TweenLite.fromTo(
                            a,
                            n, { force3D: "auto", scale: c }, {
                                scale: h,
                                onComplete: function() {
                                    a.data("loop-timeline").restart();
                                },
