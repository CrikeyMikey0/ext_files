        ...
        n = function(t, e, n, r, s, l, d, h, f) {
                ...
                setTimeout(function() {
                    ...
                    d.find(".slotslide").each(function(t) {
                        ...
                        j.add(
                                punchgs.TweenLite.fromTo(
                                    e,
                                    y / 1e3, { left: 0, top: 0, opacity: 0, transformPerspective: 600 }, {
                                        left: 0 - t * r.slotw + "px",
                                        ease: z,
                                        force3D: "auto",
                                        top: "0px",
                ...
                h.find(".slotslide").each(function() {
                    ...
                    d.find(".slotslide").each(function(t) {
                        ...
                        j.add(
                                punchgs.TweenLite.fromTo(
                                    e,
                                    y / 1e3, { left: 0, top: 0, opacity: 0, force3D: "auto" }, {
                                        left: "0px",
                                        top: 0 - t * r.sloth + "px",
            ...
            if (9 == t || 10 == t) {
                ...
                d.find(".slotslide").each(function(t) {
                    ...
                    f.add(
                        punchgs.TweenLite.fromTo(
                            e,
                            y / 1e3, { autoAlpha: 0, force3D: "auto", transformPerspective: 600 }, { autoAlpha: 1, ease: T, delay: (5 * t) / 1e3 }
                        ),
                        0
                    );
                });
            ...
            if (31 == t || 32 == t || 33 == t || 34 == t) {
                ...
                f.add(
                        punchgs.TweenLite.fromTo(
                            h,
                            B - 0.2 * B, { y: 0, x: 0 }, { y: ty, x: tx, ease: z }
                        ),
                        0.2 * B
                    ),
                    f.add(
                ...
                switch (m) {
                    case 0:
                        f.add(
                            punchgs.TweenLite.fromTo(
                                d,
                                y / 1e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: T }
                            ),
                            0
                        );
                        break;
                    case 1:
                        f.add(
                            ...
                            f.add(
                                punchgs.TweenLite.fromTo(
                                    h,
                                    y / 1e3, { autoAlpha: 1 }, { autoAlpha: 0, force3D: "auto", ease: T }
                                ),
                                0
                            );
                        break;
                    ...
                    case 4:
                        f.add(
                            ...
                            f.add(
                                punchgs.TweenLite.fromTo(
                                    d,
                                    y / 2e3, { autoAlpha: 0 }, { autoAlpha: 1, force3D: "auto", ease: T }
                                ),
                                y / 2e3
                            );
                }
                    ...
                    h.find(".slotslide").each(function(e) {
                        ...
                        f.add(
                            ...
                            f.add(
                                punchgs.TweenLite.fromTo(
                                    o,
                                    y / 2e3, { autoAlpha: 1 }, { autoAlpha: 0, delay: (50 * e) / 500 + y / 3e3, ease: z }
                                ),
                                0
                            );
                    });
